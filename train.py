...
from utils import (YOLOv3Loss, Evaluator, ModelEMA,
...
def main_work(rank, world_size, args, logger):
    ...
    model = YOLOv3(input_size=args.img_size, num_classes=len(args.class_list), anchors=args.anchors, 
    ...
    criterion = YOLOv3Loss(input_size=args.train_size, num_classes=len(args.class_list), anchors=model.anchors)
